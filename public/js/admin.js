...
var instructionlist = [dev ? "Development version: <button onclick='startExp()'>Skip instructions</button>" : "Hi! These are the instructions. Please read them carefully, there will be a short quiz at the end.", "This is part of a study being run by the University of Michigan. By clicking 'Next', you are agreeing to take part in it. You should know that you're free to withdraw at any time (although you'll only be paid on completion), and that although data gained from this study may be published, you will not be identified and your personal details will not be divulged, nor will anything be linked to your Amazon ID.</br><span style=\"font-size:.8em\">Please direct any questions about this study to the principle investigator, Steven Langsford, reachable at slangsfo at umich dot edu. If you have concerns regarding the ethics of this study and don't want to contact the investigators, you can contact the Health Sciences and Behavioral Sciences review board at irbhsbs at umich dot edu.</span>","This study takes about 15 minutes, please only continue if you have 15 minutes free without interruptions.",
